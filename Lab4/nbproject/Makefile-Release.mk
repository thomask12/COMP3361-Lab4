...
${OBJECTDIR}/BitMapAllocator.o: BitMapAllocator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../MemorySubsystemS2019 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BitMapAllocator.o BitMapAllocator.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../MemorySubsystemS2019 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
